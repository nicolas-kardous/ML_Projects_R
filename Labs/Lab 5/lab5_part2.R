# introduction to how boosting will work 
# Look at slides from last year
...
# WARNING: this took me more than 1 hour to run
...
print("Linear Regression Out-of-sample MAE:") # mean absolute error
